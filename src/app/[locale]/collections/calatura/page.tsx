...
export async function generateMetadata({
  ...
  return {
    title: "Calature",
    description: t("calatura-description"),
  };
}

// const sizeOfAsync = promisify(sizeOf);

// async function fetchCalaturaImages() {
//   const imagesDir = path.join(process.cwd(), "public/images/calatura");
//   const files = fs
      ...
      <div>
        ...
        <div className="h-[20rem] md:h-[36rem] flex justify-center md:justify-start items-center">
          <div className="md:container px-4">
            <Image
              src="/images/calatura-logo.webp"
              width={1000}
              height={1000}
              alt="Ecla lgoo"
              className="w-[18rem] md:w-[26rem] opacity-90"
            />
          </div>
        </div>
      </div>
      <div className="bg-neutral-100">
        <div className="container h-fit py-12 mb-2 md:mb-4 flex flex-col items-center justify-center px-4 gap-y-4">
          <p className="font-light text-md leading-loose md:text-xl md:leading-loose text-neutral-400">
            {t("calatura-description")}
          </p>
          <a
            href="https://www.calatura.it/en/"
